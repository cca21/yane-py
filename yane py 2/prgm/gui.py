...
class Gui:
    clearsurface = pygame.Surface((1,1),flags=pygame.SRCALPHA)
    clearsurface.fill(pygame.Color(0,0,0,1))
    pygame.display.set_icon(clearsurface)
    screen = pygame.display.set_mode(size=(256,192),flags=pygame.RESIZABLE|pygame.SCALED)
    pygame.display.set_caption('YANEpy')
